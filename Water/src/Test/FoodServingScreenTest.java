...
public class FoodServingScreenTest {
	 ...
	 * 
	 * Test the foodServingScreen constructor to ensure that the screen was
	 * constructed by testing that the data member testFoodServingScreen is not
	 * null/exists
	 */
	@Test
	 ...
	 * testMakeTopButton()
	 * 
	 * Test to test that the makeTopButton function accurately create the action
	 * listener for the buttons on the top panel so that when they are clicked,
	 * the water footprint is accurately increased
	 */
	@Test
	public void testMakeTopButton() {
		// change the expected values: number of buttons clicked should be 1,
		// and the expected amount of water is the water footprint of one
		// serving of beer
		...
		// size should be 1 because there should only be one button in that
		// panel
	 ...
	 * 
	 * Tests that the function makeBottomButton accurately creates the action
	 * listener for the buttons on the bottom panel so that when they are
	 * clicked the water footprint accurately decreases
	 */
	@Test
	 ...
	 * listeners can be tested, and initializes the expected and actual data
	 * members to 0 so they can be accurately changed in each test
	 * 
	 * @throws Exception
	 */
	@Before
